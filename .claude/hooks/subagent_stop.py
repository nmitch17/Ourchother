...
def announce_subagent_completion():
    """Announce subagent completion with fallback to pyttsx3."""
    try:
        ...
        # Fallback to pyttsx3 (offline, always works)
        pyttsx3_script = tts_dir / "pyttsx3_tts.py"
        if pyttsx3_script.exists():
            subprocess.run([
...
def main():
    try:
        ...
        parser.add_argument('', action='store_true', help='Enable TTS completion announcement')
